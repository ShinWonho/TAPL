...
//        println(cnt + ": " + concrete(res))
  ...
  println("@Normal form: " + concrete(res))
  println("total step: " + cnt)
//  concrete(res)
}
...
println("6 == 10:")
big_step(App(App(Equal(), Church(6)), Church(10)))

println("2!:")
//big_step(App(factorial(), Church(2)))